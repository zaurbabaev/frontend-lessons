...
/* datas.forEach(item => {
  ...
  const tdElementCompanyName = document.createElement("td");
  ...
  tdElementCompanyName.innerText = item.companyName;
  tdElementContactName.innerText = item.contactName;
  tdElementContactTitle.innerText = item.contactTitle;

  trElement.append(tdElementId);
  trElement.append(tdElementCompanyName);
  trElement.append(tdElementContactName);
  trElement.append(tdElementContactTitle);
